...
public class exportOpenTickets {
    ...
    public void exportOpenTickets_txt() {
        ...
        String query =  "SELECT " +
                ...
                "'ticket_state' " +
                "UNION " +
                "SELECT * FROM ticketingdatabase.ticket WHERE ticket_state = 1";
        ...
        try (Connection connection = DriverManager.getConnection(
            ...
            Path filepath = Paths.get(myApplicationBean.getSavePath(), "openexport_" + currentDate + ".txt");
            Files.write(filepath, resultData);

            Path csvfilepath = Paths.get(myApplicationBean.getSavePath(), "openexport_" + currentDate + ".csv");
